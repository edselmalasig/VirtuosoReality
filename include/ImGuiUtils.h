...
namespace ImGui
{
    ...
    inline void SetupImGuiStyle( bool bStyleDark_, float alpha_  )
    {
        ...
        style.Colors[ImGuiCol_WindowBg]              = ImVec4(0.60f, 0.30f, 0.00f, 0.94f);
        style.Colors[ImGuiCol_ChildWindowBg]         = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
        style.Colors[ImGuiCol_PopupBg]               = ImVec4(1.00f, 1.00f, 1.00f, 0.94f);
        style.Colors[ImGuiCol_Border]                = ImVec4(0.00f, 0.00f, 0.00f, 0.39f);
        style.Colors[ImGuiCol_BorderShadow]          = ImVec4(1.00f, 1.00f, 1.00f, 0.10f);
        style.Colors[ImGuiCol_FrameBg]               = ImVec4(0.20f, 0.20f, 0.20f, 0.94f);
        style.Colors[ImGuiCol_FrameBgHovered]        = ImVec4(0.26f, 0.59f, 0.98f, 0.40f);
        style.Colors[ImGuiCol_FrameBgActive]         = ImVec4(0.26f, 0.59f, 0.98f, 0.67f);
        style.Colors[ImGuiCol_TitleBg]               = ImVec4(0.94f, 0.40f, 0.40f, 0.94f);
        style.Colors[ImGuiCol_TitleBgCollapsed]      = ImVec4(1.00f, 1.00f, 1.00f, 0.51f);
        style.Colors[ImGuiCol_TitleBgActive]         = ImVec4(0.80f, 0.40f, 0.00f, 0.94f);
        ...
        style.Colors[ImGuiCol_CheckMark]             = ImVec4(0.98f, 0.59f, 0.26f, 1.00f);
        style.Colors[ImGuiCol_SliderGrab]            = ImVec4(0.88f, 0.52f, 0.24f, 1.00f);
        style.Colors[ImGuiCol_SliderGrabActive]      = ImVec4(0.98f, 0.59f, 0.26f, 1.00f);
        style.Colors[ImGuiCol_Button]                = ImVec4(0.60f, 0.20f, 0.00f, 0.94f);
        style.Colors[ImGuiCol_ButtonHovered]         = ImVec4(1.00f, 0.50f, 0.00f, 1.00f);
        style.Colors[ImGuiCol_ButtonActive]          = ImVec4(0.00f, 1.00f, 0.00f, 1.00f);
        style.Colors[ImGuiCol_Header]                = ImVec4(0.98f, 0.59f, 0.26f, 0.31f);
        style.Colors[ImGuiCol_HeaderHovered]         = ImVec4(0.98f, 0.59f, 0.26f, 0.80f);
        style.Colors[ImGuiCol_HeaderActive]          = ImVec4(0.98f, 0.59f, 0.26f, 1.00f);
        ...
        style.Colors[ImGuiCol_ResizeGripHovered]     = ImVec4(0.98f, 0.59f, 0.26f, 0.67f);
        style.Colors[ImGuiCol_ResizeGripActive]      = ImVec4(0.98f, 0.59f, 0.26f, 0.95f);
        style.Colors[ImGuiCol_CloseButton]           = ImVec4(1.00f, 0.00f, 0.00f, 1.00f);
        style.Colors[ImGuiCol_CloseButtonHovered]    = ImVec4(0.98f, 0.39f, 0.00f, 1.00f);
        style.Colors[ImGuiCol_CloseButtonActive]     = ImVec4(0.98f, 0.39f, 0.00f, 1.00f);
        style.Colors[ImGuiCol_PlotLines]             = ImVec4(0.39f, 0.39f, 0.39f, 1.00f);
        style.Colors[ImGuiCol_PlotLinesHovered]      = ImVec4(1.00f, 0.43f, 0.35f, 1.00f);
        style.Colors[ImGuiCol_PlotHistogram]         = ImVec4(0.90f, 0.70f, 0.00f, 1.00f);
        style.Colors[ImGuiCol_PlotHistogramHovered]  = ImVec4(1.00f, 0.60f, 0.00f, 1.00f);
        style.Colors[ImGuiCol_TextSelectedBg]        = ImVec4(0.98f, 0.59f, 0.26f, 0.35f);
        style.Colors[ImGuiCol_ModalWindowDarkening]  = ImVec4(0.80f, 0.80f, 0.80f, 0.35f);
		
        //end intel style.colors
    ...
    {
        return 0;//CheckBoxFont( name_, pB_, ICON_MD_CHECK_SQUARE_O, ICON_MD_SQUARE_O );
    }
    ...
    inline bool MenuItemCheckbox( const char* name_, bool* pB_ )
    {
        ...
        if( *pB_ )
        {
            //ImGui::Text(ICON_MD_CHECK_SQUARE_O);
        }
        else
        {
            //ImGui::Text(ICON_MD_SQUARE_O);
        }
        if( retval )
        {
            *pB_ = ! *pB_;
